...
\usepackage{pmmeta}
\pmcanonicalname{Hcobordism}
\pmcreated{2013-03-22 13:57:19}
\pmmodified{2013-03-22 13:57:19}
\pmowner{bwebste}{988}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
A cobordism $(N,M,M')$ is called an $h$-cobordism if the inclusion maps $i:M\to N$ and $i':M'\to N$ are homotopy equivalences.
%%%%%
%%%%%
\end{document}
