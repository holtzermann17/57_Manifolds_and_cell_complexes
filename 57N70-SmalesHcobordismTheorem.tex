...
\usepackage{pmmeta}
\pmcanonicalname{SmalesHcobordismTheorem}
\pmcreated{2013-03-22 13:57:22}
\pmmodified{2013-03-22 13:57:22}
\pmowner{bwebste}{988}
\pmmodifier{bwebste}{988}
\pmtitle{Smale's $h$-cobordism theorem}
\pmrecord{5}{34721}
\pmprivacy{1}
...
\newcommand{\Zp}{\Z/p}
\begin{document}
Let $(N,M,M')$ be an \PMlinkname{$h$-cobordism}{HCobordism} of smooth manifolds with $N$ (and hence $M$ and $M'$) simply connected, and $\dim(M)\geq 5$.  Then $N\cong M\times [0,1]$ and $M$ and $M'$ are diffeomorphic.
%%%%%
%%%%%
\end{document}
